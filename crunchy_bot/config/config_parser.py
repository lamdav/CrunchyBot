...
class Config(object):
    ...
    def __eq__(self, other):
        if not isinstance(other, Config):
            return False
        return self.crunchy_username == other.crunchy_username \
    ...
    def __hash__(self):
        return hash((self.crunchy_username, self.crunchy_password, self.reddit_client_id, self.reddit_client_secret,
                     self.reddit_user_agent, self.reddit_username, self.reddit_password, self.log_dir))
